...
public class SetupExample extends Command {
    private Supplier<IStatement> programSupplier;
    private IController controller;

    public SetupExample(String key, String description, Supplier<IStatement> programSupplier, IController controller) {
